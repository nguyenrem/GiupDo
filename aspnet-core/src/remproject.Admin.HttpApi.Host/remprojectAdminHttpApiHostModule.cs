...
public class remprojectAdminHttpApiHostModule : AbpModule
{
    ...
    {
        Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "remproject:"; });
    }
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<remprojectDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}remproject.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<remprojectDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
